...
/**
 * Fixture data exported from local `service_package` table on 2026-05-22 05:27:16.
 * Regenerate: php scripts/generate-fixtures-from-db.php
 */
class ServicePackageFixtures extends Fixture implements DependentFixtureInterface
{
